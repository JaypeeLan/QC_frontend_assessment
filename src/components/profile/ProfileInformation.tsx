    ...
    return (
        <div className="flex flex-col gap-8 w-full max-w-5xl mx-auto px-4 sm:px-0">
            ...
            <div className="flex justify-end gap-4 mt-4 pb-20">
                <Button variant="outline" size="md" className="h-[50px] px-10 font-bold text-[#374151] border-[#D1D5DB] hover:bg-gray-50 rounded-[var(--radius-8)]">Cancel Changes</Button>
                <Button variant="primary" size="md" className="h-[50px] px-10 font-bold bg-[#005EA2] rounded-[var(--radius-8)]">Save Changes</Button>
            </div>
        </div>
    );
}
